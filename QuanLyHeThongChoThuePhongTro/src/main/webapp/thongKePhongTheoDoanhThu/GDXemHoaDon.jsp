...
%>
<body>
<header><h1>Xem hóa đơn</h1></header>
<h5>Số phòng: <%=hoaDon.getPhong().getSoPhong()%></h5>
<h5>Ngày: <%=new SimpleDateFormat("dd/MM/yyyy").format(hoaDon.getNgay()) %></h5>
...
<td>Chỉ số cũ: <%=tieuThu.getDsChiSoTieuThu().get(0).getChiSoCongTo().getChiSo()%>
<td>Chỉ số mới: <%=tieuThu.getDsChiSoTieuThu().get(1).getChiSoCongTo().getChiSo()%>
<td>Số điện tiêu thụ: <%=tieuThu.getDsChiSoTieuThu().get(1).getChiSoCongTo().getChiSo() - tieuThu.getDsChiSoTieuThu().get(0).getChiSoCongTo().getChiSo()%></td>
</tr>
<table>
<tr>
<th>TT</th>
...
<td>Chỉ số cũ: <%=tieuThu.getDsChiSoTieuThu().get(0).getChiSoCongTo().getChiSo()%>
<td>Chỉ số mới: <%=tieuThu.getDsChiSoTieuThu().get(1).getChiSoCongTo().getChiSo()%>
<td>Số nước tiêu thụ: <%=tieuThu.getDsChiSoTieuThu().get(1).getChiSoCongTo().getChiSo() - tieuThu.getDsChiSoTieuThu().get(0).getChiSoCongTo().getChiSo()%></td>
</tr>
<table>
<tr>
<th>TT</th>
...
<td><%=listDichVuHoaDon.get(i).getGia()%> vnđ</td>
